...
My research spans **digital health**, **human–computer interaction (HCI)**, **user-centered computing and sensing**, and **mobile security,** with a strong focus on **acoustic sensing**. Examples include some exciting **ultrasound sensing** on the headsets through hardware–software co-design, and **dual-modality speaker authentication** on earbuds that reaches a 1.5% EER with 0.06 s mean latency on mobile devices. I have also worked on **3D posture reconstruction** with passive infrared sensors and fiber-optic **vital-sign monitoring**, aiming for accurate sensing with low latency and low energy cost.
